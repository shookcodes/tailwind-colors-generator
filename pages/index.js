...
export default function Home() {
  ...
  return (
    <div>
      ...
      <div
        id="container"
        className="flex flex-col items-center justify-between border-2 border-green-500 h-full w-11/12 mx-auto m-8  bg-gray-50 rounded-lg pt-8  shadow-lg max-w-screen-lg select-none "
      >
        {/* Below div wraps the content so that the top of the menu dropdown overflow is hidden when the menu is open */}
        <div className="w-full h-max  px-4 pb-28 overflow-hidden">
